...
- Fixed bad links to source code in ReadMe and updated links per changes
  ...
  - partly fixes
    [issue](https://github.com/ocean-tracking-network/glatos/issues/269)
...
- Add `validate` argument to
  ...
  - related to
    [issue](https://github.com/ocean-tracking-network/glatos/issues/202)
    [\#202](https://github.com/ocean-tracking-network/glatos/issues/202)
...
- Fixed bug in
  ...
  - fixes
    [issue](https://github.com/ocean-tracking-network/glatos/issues/278)
    [\#278](https://github.com/ocean-tracking-network/glatos/issues/278)
...
- Fixed bug in
  ...
  - fixes
    [issue](https://github.com/ocean-tracking-network/glatos/issues/277)
    [\#277](https://github.com/ocean-tracking-network/glatos/issues/277)
...
- Fixed bug in
  ...
  ‘Tag.ID’ as character (as well as integer). convert_glatos_to_att()
  now returns ‘Tag.ID’ as character.
  - fixes
    [issue](https://github.com/ocean-tracking-network/glatos/issues/276)
    [\#276](https://github.com/ocean-tracking-network/glatos/issues/276)
- Optimized `convert_sex()` to use data.table::fcase for text
  translation instad of sapply() over each row.
...
- Fixed bug in
  ...
  - fixes
    [issue](https://github.com/ocean-tracking-network/glatos/issues/275)
    [\#275](https://github.com/ocean-tracking-network/glatos/issues/275)
...
- Fixed bug in
  ...
  vector”.
  - fixes
    [issue](https://github.com/ocean-tracking-network/glatos/issues/274)
    [\#274](https://github.com/ocean-tracking-network/glatos/issues/274)
...
- Added support for GLATOS workbook version 1.4 (xlsx file) in
  ...
  - Excel workbooks in version 1.4 have no macros and have column
    ...
    had macros).
  - Added new input argument `simplify` which allows (when
    `simplify = TRUE`) return of a list with the same structure as the
    input workbook (e.g., columns named “Deployment”, “Recovery”,
    “Tagging”, …).
  - Disallow multiple columns with the same name (returns an error). In
    earlier versions, a suffix was added to all but the first in each
    set of duplicate column names.
  - fixes
...
- Changed case of vdat.exe and paths to vdat.exe and vue.exe in tests
  (new default install locations on windows).
  - fixes
    [issue](https://github.com/ocean-tracking-network/glatos/issues/253)
    [\#253](https://github.com/ocean-tracking-network/glatos/issues/253)
- Added DIAG_NEXTRAK record type to vdat_csv_schema data object.
  - fixes
    [issue](https://github.com/ocean-tracking-network/glatos/issues/265)
    [\#265](https://github.com/ocean-tracking-network/glatos/issues/265)
- Added explicit calls to data objects so that they can be accessed when
  the package isn’t attached.
  - fixes
...
- Allowed
  ...
  - fixes
    ...
    [\#262](https://github.com/ocean-tracking-network/glatos/issues/262)
...
- Changed
  ...
  - fixes
    [issue](https://github.com/ocean-tracking-network/glatos/issues/234)
    [\#234](https://github.com/ocean-tracking-network/glatos/issues/234)
- Removed `make_transition2()` (deprecated in 0.7) and
  `make_transition3()`. Also removed dependence on `fasterize`.
  - fixes
...
- Updated example TransitionLayer object `greatLakesTrLayer` using new
  ...
  will differ from earlier versions.
  - fixes
    [issue](https://github.com/ocean-tracking-network/glatos/issues/219)
    [\#219](https://github.com/ocean-tracking-network/glatos/issues/219)
...
- Add new functions to create, check, and validate `glatos_animals`
  ...
  - fixes
    ...
    [\#126](https://github.com/ocean-tracking-network/glatos/issues/126)
  - fixes
    [issue](https://github.com/ocean-tracking-network/glatos/issues/78)
...
- Fix typo in Description to Suggest ‘gifski’ (not ‘gifsky’).
  - fixes
    [issue](https://github.com/ocean-tracking-network/glatos/issues/185)
    [\#185](https://github.com/ocean-tracking-network/glatos/issues/185)
- Various changes to resolve R CMD check errors, warning, and notes
...
- Fixed bug in
  ...
  - Likely a side effect of [commit
    ...
    which aimed to fix
    [issue](https://github.com/ocean-tracking-network/glatos/issues/182)
    [\#182](https://github.com/ocean-tracking-network/glatos/issues/182)
...
- Fixed bug in
  ...
  - cherry-picked from [commit
    db9d69a](https://github.com/ocean-tracking-network/glatos/commit/db9d69a3d08a97e7b8f86e0d4977aa0909776ddd)
...
- Fix bug introduced in glatos 0.7.0 where x and y limits were switched
  ...
  - Add test for various inputs of `background_xlim`, `background_ylim`,
    and `bg_map` to function `make_frames`.
...
- Deprecate `make_transition` and `make_transition2`; suggest
  `make_transition3` instead.
...
- `prepare_deploy_sheet`:
  ...
  - Set ‘skip = header_line - 1’ and ‘col_names = TRUE’ to retain first
    record and column names (read_excel ignores column names, unless
    set, when skip is set).
...
- Fix issues with several tests caused by changes to CRS/WKT and
...
- Fix bug in summarize_detections() where setting ‘location_col’
  triggers error.
  - fixes
    [issue](https://github.com/ocean-tracking-network/glatos/issues/180)
    [\#180](https://github.com/ocean-tracking-network/glatos/issues/180)
...
- Add support for new column named ‘record_status’ in GLATOS detection
  export CSV.
  - Add new glatos detection schema version 1.4 (developer use)
  - fix
    [issue](https://github.com/ocean-tracking-network/glatos/issues/179)
    [\#179](https://github.com/ocean-tracking-network/glatos/issues/179)
...
- Add support for new GLATOS receiver_locations file format; with
  code_map and code_map_comment columns.
  - fix
    [issue](https://github.com/ocean-tracking-network/glatos/issues/177)
    [\#177](https://github.com/ocean-tracking-network/glatos/issues/177)
...
- crw_in_polygon
  ...
  - unlike previous versions, input polygon (‘polyg’) must now be in
    Cartesian (projected) coordinate reference system or ‘cartesianCRS’
...
- transmit_along_path
  - remove dependence on sp
  - return sf object (default) or data.frame
  - calculate distances along path using geodist::geodist for geographic
    and simple Euclidean for Cartesian coordinates. Cartesian input
    results in fastest computations.
  - remove EPSG input (no longer requires transformation to Cartesian
    CRS for calculations); but non-Cartesian input will be slower than
    Cartesian.
...
- position_heat_map
  ...
  - fix
    [issue](https://github.com/ocean-tracking-network/glatos/issues/159)
    [\#159](https://github.com/ocean-tracking-network/glatos/issues/159)
    where kmz output worked on mac but not windows
  - fix
    [issue](https://github.com/ocean-tracking-network/glatos/issues/123)
    [\#123](https://github.com/ocean-tracking-network/glatos/issues/123)
...
- remove dependence on gdalUtils
  ...
  - use gdalUtilities::gdal_rasterize instead of
    gdalUtils::gdal_rasterize
  - fix
    [issue](https://github.com/ocean-tracking-network/glatos/issues/174#)
    [\#174](https://github.com/ocean-tracking-network/glatos/issues/174)
  - removed gdalUtils dependency from DESCRIPTION and added
    gdalUtilities
...
- fix ‘greatLakesPoly’ CRS to resolve warning: “CRS object has no
  comment”
...
- read_glatos_workbook
  ...
  - fix
    [issue](https://github.com/ocean-tracking-network/glatos/issues/138#)
    [\#138](https://github.com/ocean-tracking-network/glatos/issues/138)

- removed openxlsx and cellranger dependencies from DESCRIPTION

- fix issue preventing vignettes from building when installed (missing
  space in data_loading_vignette.Rmd).
...
- position_heat_map
  - fix issue
    [\#121](https://github.com/ocean-tracking-network/glatos/issues/121)
    (error when input does not contain columns X and Y)
...
- residence_index
  - replaced deprecated .dots with across in dplyr::group_by calls to
    fix “Warning: The `.dots` argument of
    [`group_by()`](https://dplyr.tidyverse.org/reference/group_by.html)
    is deprecated as of dplyr 1.0.0”
- convert_otn_erddap_to_att
  - renamed convert_otn_to_att to convert_otn_erddap_to_att to better
...
- make_transition
  - added new argument ‘invert’ for cases where input polygon represents
    land
  - fixes issue
    [\#101](https://github.com/ocean-tracking-network/glatos/issues/101)

#### Bug fixes

- read_glatos_detections
  - fix bug where animal_id was not created correctly if some but not
    all were missing
  - fixes issue
    [\#106](https://github.com/ocean-tracking-network/glatos/issues/106)
...
- make_video
  - overhauled to no longer require ffmpeg. now is a simple wrapper for
    av::av_encode_video
  - added input argument ‘duration’ to set total video duration in
    seconds previous version of make_video renamed ‘make_video_ffmpeg’
...
- interpolate_path
  - set `ties = "ordered"` for all calls to
    [`stats::approx`](https://rdrr.io/r/stats/approxfun.html)
  - fixes issue
    [\#93](https://github.com/ocean-tracking-network/glatos/issues/93)

#### Bug fixes

- abacus_plot
  - fix issue where optional plot args passed as expressions (e.g.,
    `panel.first` and `panel.last`) had to be wrapped in `quote`
  - fixes issue
    [\#87](https://github.com/ocean-tracking-network/glatos/issues/87)
- summarize_detections
  - fix error in documentation listing all three summ_type options as
    default
  - fixes issue
    [\#94](https://github.com/ocean-tracking-network/glatos/issues/94)
- check_dependencies
  - ensure that glatos package directory is checked for ffmpeg.exe
  - fixes issue
    [\#95](https://github.com/ocean-tracking-network/glatos/issues/95)
...
- make_frames
  - add argument show_progress (default = TRUE) to optionally supress
    progress bars
  - issue
    [\#74](https://github.com/ocean-tracking-network/glatos/issues/74)
- interpolate_path
  - add argument show_progress (default = TRUE) to optionally supress
    progres bars
  - issue
...
- calc_collision_probs
  - in help examples, make separate plots for detection and collision
    probs
  - issue
    [\#77](https://github.com/ocean-tracking-network/glatos/issues/77)
- make_video
  - issue
    [\#64](https://github.com/ocean-tracking-network/glatos/issues/64)
  - return output file name
  - add diagnostic_mode arg to optionally return ffmpeg output (hide by
    default)
...
- vrl2csv
  - fixed bug where output csv file names were not returned when input  
    was multiple VRL file names. A vector of output CSV file names is
    now returned.
...
- make_frames
  - fixed bug where receivers were not displayed near the end of the
    time series in the images (and videos) when some receivers were
    missing recovery data (issue
    [\#79](https://github.com/ocean-tracking-network/glatos/issues/79)).
- abacus_plot
  ...
  - fixed bug where plot title (specified by *main* argument) was not
    included in plot (issue
    [\#70](https://github.com/ocean-tracking-network/glatos/issues/70))
  - deprecated *show_receiver_status* argument. Receiver status will be
    shown on plot whenever ‘receiver_history’ is given.
...
- vignettes and documentation
  - added data-loading, data-requirements, receiver_efficency,
    residence_index
...
- detection_events
  ...
  - coerce ‘time_sep’ argument to numeric if quoted and error if it
...
- crw_in_polygon
  ...
  - added explicit coordinate reference system (EPSG 3175 - Great Lakes
    projected CRS) so that default units are in meters and simulations
    are done in that CRS. Other CRS can be specified for other areas
    (via EPSG argument).
...
- abacus_plot
  ...
  - added optional arguments *show_receiver_status* and
    *receiver_history* to allow receiver history status to be added to
    plot (issue
    [\#36](https://github.com/ocean-tracking-network/glatos/issues/36))
  - added optional arguments *x_res* and *x_format* to specify x-axis
    tick mark spacing and format (issue
    [\#30](https://github.com/ocean-tracking-network/glatos/issues/30))
  - removed input arguments that could also be passed via ellipses
    (issue
    [\#35](https://github.com/ocean-tracking-network/glatos/issues/35))

- position_heat_map

  - corrected accuracy issues by converting lat-lon to UTM (issue
    [\#8](https://github.com/ocean-tracking-network/glatos/issues/8))
  - added optional argument *abs_or_rel* to specify it output is
    absolute numbers of fish are relative; simplified output so that
    only a single output type occurs in a given call
  - Changed output to kmz instead of kml
  - new folder is only created when output is png or kmz

- dropped fasttime as a depenedency and uses lubridates fasttime
...
- read_otn_detections
  - fix bug that indexed columns by position, meaning columns had to be
    orderd exactly as in spec (issue
    [\#52](https://github.com/ocean-tracking-network/glatos/issues/52))
- read_glatos_detections
  - fix bug that indexed columns by position, meaning columns had to be
    orderd exactly as in spec (issue
    [\#52](https://github.com/ocean-tracking-network/glatos/issues/52))
...
- added check_dependencies() for checking if gdal and ffmpeg can be
  called (issue
  [\#40](https://github.com/ocean-tracking-network/glatos/issues/40))

#### Minor changes and bug fixes

- adjust_playback_time()
  - allow spaces in file names and paths (issue
    [\#45](https://github.com/ocean-tracking-network/glatos/issues/45))
- interpolate_path()
  - trigger error when ‘trans’ is not a transition object (issue
    [\#42](https://github.com/ocean-tracking-network/glatos/issues/42))
- make_frames()
  - fixed “cannot allocate vector” error when optional plot arg is
    vector (issue
    [\#47](https://github.com/ocean-tracking-network/glatos/issues/47))
- make_transition()
  - allow polygon to be input as SpatialPolygonsDataFrame (issue
    [\#37](https://github.com/ocean-tracking-network/glatos/issues/37))
...
- make_video()
  - added support for input and output directories containing spaces
    (issue
    [\#38](https://github.com/ocean-tracking-network/glatos/issues/38))
