...
receiver locations to a `sf` object and display using
...
[`mapview()`](https://r-spatial.github.io/mapview/reference/mapView.html)
and filter out the points we want. Then save as an excel and/or gpx
file.
...
#> Rows: 898
#> Columns: 23
#> $ station               <chr> "WHT-009", "FDT-001", "FDT-004", "FDT-003", "FDT-002"…
#> $ glatos_array          <chr> "WHT", "FDT", "FDT", "FDT", "FDT", "DTR", "DTR", "DTR…
#> $ station_no            <chr> "9", "1", "4", "3", "2", "1", "2", "3", "4", "1", "1"…
#> $ consecutive_deploy_no <int> 1, 2, 2, 2, 2, 2, 2, 2, 2, 1, 5, 2, 1, 2, 2, 1, 2, 2,…
#> $ intend_lat            <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ intend_long           <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ deploy_lat            <dbl> 43.74216, 45.93014, 45.94764, 45.93794, 45.92377, 45.…
#> $ deploy_long           <dbl> -82.50791, -83.50204, -83.48847, -83.46884, -83.48483…
#> $ recover_lat           <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ recover_long          <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ deploy_date_time      <dttm> 2010-09-22 18:05:00, 2010-11-12 15:07:00, 2010-11-12…
#> $ recover_date_time     <dttm> 2012-08-15 16:52:00, 2012-05-15 13:25:00, 2012-05-15…
#> $ bottom_depth          <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 1.5, NA, …
#> $ riser_length          <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0.5, NA, …
#> $ instrument_depth      <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 1, NA, NA…
#> $ ins_model_no          <chr> "VR2W", "VR3", "VR3", "VR3", "VR3", "VR3", "VR3", "VR…
#> $ glatos_ins_frequency  <int> 69, 69, 69, 69, 69, 69, 69, 69, 69, 69, 69, 69, 69, 6…
#> $ ins_serial_no         <chr> "109450", "442", "441", "444", "447", "439", "445", "…
#> $ deployed_by           <chr> "", "", "", "", "", "", "", "", "", "", "", "", "", "…
#> $ comments              <chr> "", "", "", "", "", "", "", "", "", "", "", "", "", "…
#> $ glatos_seasonal       <chr> "NO", "No", "No", "No", "No", "No", "No", "No", "No",…
#> $ glatos_project        <chr> "HECWL", "DRMLT", "DRMLT", "DRMLT", "DRMLT", "DRMLT",…
#> $ glatos_vps            <chr> "NO", "No", "No", "No", "No", "No", "No", "No", "No",…
```
...
Next, we will bring in our example data which is loaded with
[glatos](https://github.com/ocean-tracking-network/glatos) but you will
need to replace `sample_detection_efficiency` with your data frame
either by loading the csv produced by Innovasea software. You can do
this multiple ways, I prefer using `readr::read_csv()` but base R works
perfectly fine.
...
2.  If a third order polynomial model is selected, the formula call can
    ...
    sets the y-intercept. The y-intercept needs to be set to 100, as x
    needs to equal 0 m from a receiver because you expect to hear a tag
    100% of the time.
...
m
#> # A tibble: 3 × 19
#>       p distance    df chi_square      pgof     a  a_se a_sig        b     b_se b_sig
#>   <dbl>    <dbl> <int>      <dbl>     <dbl> <dbl> <dbl> <dbl>    <dbl>    <dbl> <dbl>
#> 1    10      634     4      1304. 4.20e-281 0.202 0.183 0.332 -0.00136 0.000753 0.145
#> 2    50      371     4      1304. 4.20e-281 0.202 0.183 0.332 -0.00136 0.000753 0.145
#> 3    90      217     4      1304. 4.20e-281 0.202 0.183 0.332 -0.00136 0.000753 0.145
#> # ℹ 8 more variables: d <dbl>, d_se <dbl>, d_sig <dbl>, offset <dbl>,
#> #   resid_se <dbl>, r2 <dbl>, adj_r2 <dbl>, aic <dbl>
```
...
![](detection_efficiency_vignette_files/figure-html/unnamed-chunk-20-1.png)
...
![](detection_efficiency_vignette_files/figure-html/unnamed-chunk-21-1.png)
