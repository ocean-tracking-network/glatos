...
after about 400 m (Figure 4).  At this point, statistical models may be used to
extract a generalized detection range curve or detection range curves
may be used in simulation modelling to estimate the probability of detecting a fish moving
through a line of receivers.  The `GLATOS` package includes functions
to facilitate these simulation analyses and examples are included in "An
introduction to R for analyzing acoustic telemetry data" workhop
manual.  Workshop manual may be downloaded from
https://glatos.glos.us/
^[Workshop manual is located in the data portal in the "tools" tag]
