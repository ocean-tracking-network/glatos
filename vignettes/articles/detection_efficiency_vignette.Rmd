...
You can download `sample_detection_efficiency` (.rds format) [here](../sample_detection_efficiency.rds)

**Note:** Source information for `sample_detection_efficiency` data:

::: {.info-box}

* **Title:** Detection Efficiency data set

* **Description:** Sample detection efficiency data set from Lake Papineau, Quebec, Canada.

* **Details:** Data is from a preliminary range test, where tags were deployed at set distances away from a VR2W receiver for 24 hours.

* **Format:** A data frame with 7 rows and 5 variables:

<div class="variable-list">
  <div class="variable-name">distance_m</div>
  <div class="variable-description">distance away from the receiver in meters</div>

  <div class="variable-name">avg_percent</div>
  <div class="variable-description">average detection efficiency</div>

  <div class="variable-name">std_dev</div>
  <div class="variable-description">standard deviation of detection efficiency</div>

  <div class="variable-name">avg_percent_d</div>
  <div class="variable-description">average detection efficiency in decimal form needs to be created by dividing avg_percent by 100</div>

  <div class="variable-name">intercept</div>
  <div class="variable-description">y-intercept used for third order polynomial, set at 100. Needs to be added to the original dataframe</div>
</div>
...
sample_detection_efficiency <- readRDS("../../docs/sample_detection_efficiency.rds")
