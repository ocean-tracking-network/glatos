...
```{r}
boxplot(residency_index ~ location,
  data = ri, horizontal = TRUE, las = 1,
...
rik2 <- residence_index(det_events,
  locations = locs,
...
```{r}
rik3 <- residence_index(det_events,
  locations = locs,
  calculation_method = "kessel",
...
```{r}
riti <- glatos::residence_index(det_events,
  locations = locs,
...
```{r, fig.width=5, fig.height=5}
ritd <- glatos::residence_index(det_events,
  locations = locs,
...
```{r, fig.width=5, fig.height=5}
riawo <- glatos::residence_index(det_events,
  locations = locs,
...
```{r, fig.width=5, fig.height=5}
riano <- glatos::residence_index(det_events,
  locations = locs,
  calculation_method = "aggregate_with_overlap",
  group_col = NA
)
