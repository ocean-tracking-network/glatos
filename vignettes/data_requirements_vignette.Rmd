...
obtained from the GLATOS [Data Portal](https://glatos.org/portal).
...
Package](https://glatos.org/static/GLATOSWeb_Submission_Package.zip) in the
[GLATOS Data Portal](https://glatos.org/portal).
