...
standard GLATOS project workbook (\*.xlsm file) and checks that the
data meet requirements of *glatos* functions. Data are read using *readWorkbook* in the
*openxlsx* package, timestamps are formatted as class *POSIXct*.
...
The result is a list object with `r ncol(rcv2)` columns and two classes:
