...
test_that("write_vdat_csv works", {
  ...
  # compare attributes
  expect_equal(attributes(vdat)[c("names", "class", "fathom_csv_version")],
               attributes(vdat2)[c("names", "class", "fathom_csv_version")])
  
  # check unique attribute
  expect_equal(attributes(vdat2)[["source"]],
...
test_that("bad inputs are caught", {
  ...
  temp_file <- tempfile(fileext = ".csv")
  expect_error(write_vdat_csv(unclass(vdat), out_file = temp_file),
...
test_that("format_POSIXt() works", {
  ...
  # POSIXct input
  t1 <- as.POSIXct(
    c("2011-03-08 23:59:58",
      "2011-03-08 23:59:58.828867"),
    tz = "UTC")
  
  
 expect_equal(format_POSIXt(t1, digits = 5, drop0trailing = FALSE),
              c("2011-03-08 23:59:58.00000", "2011-03-08 23:59:58.82887"))
 
 expect_equal(format_POSIXt(t1, digits = 3, drop0trailing = TRUE),
              c("2011-03-08 23:59:58", "2011-03-08 23:59:58.829"))
 
 expect_equal(format_POSIXt(t1, digits = 0),
              c("2011-03-08 23:59:58", "2011-03-08 23:59:59"))
 
 # POSIXlt input
 t2 <- as.POSIXlt(t1)
 
 expect_equal(format_POSIXt(t2, digits = 5, drop0trailing = FALSE),
              c("2011-03-08 23:59:58.00000", "2011-03-08 23:59:58.82887"))
 
 expect_equal(format_POSIXt(t2, digits = 3, drop0trailing = TRUE),
              c("2011-03-08 23:59:58", "2011-03-08 23:59:58.829"))
 
 expect_equal(format_POSIXt(t2, digits = 0),
              c("2011-03-08 23:59:58", "2011-03-08 23:59:59")) 
 
  
 # catch non-posix input
 
 expect_error(format_POSIXt(as.character(t1)), 
