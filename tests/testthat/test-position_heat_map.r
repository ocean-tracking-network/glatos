...
phm_kmz_out_nameShouldBe <- normalizePath(
  file.path(
    temp_dir,
    "fish_absolute.kmz"
  ),
...
phm_kmz_out_named_nameShouldBe <- normalizePath(
  file.path(
    temp_dir,
    "mymap.kmz"
  ),
...
phm_png_out_nameShouldBe <- normalizePath(
  file.path(
    temp_dir,
    "fish_absolute.png"
  ),
...
phm_png_out_named_nameShouldBe <- normalizePath(
  file.path(
    temp_dir,
    "mymap.png"
  ),
