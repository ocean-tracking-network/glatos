...
data(greatLakesPoly)
set.seed(30)
path_spin_spout <- crw_in_polygon(greatLakesPoly,
...
set.seed(30)
path_spin_dfout <- crw_in_polygon(greatLakesPoly,
  theta = c(0, 25), stepLen = 10000,
...
path_spin_dfout_shouldBe <-
  structure(list(x = c(
    -87.49017, -87.5682764367357, -87.6624051520051,
    -87.7763030863065, -87.8344478577291, -87.9595460531474
  ), y = c(
    48.42314,
    48.4965252233601, 48.5611619523508, 48.609942977839, 48.6911737155544,
    48.7263225805848
  )), class = "data.frame", row.names = c(1L:6L))
...
path_dfin_dfout_shouldBe <-
  structure(list(x = c(
    0, -4.34765355285354, -9.75360353139628,
    -16.5935673247779, -19.6317805370012, -16.4086037689043
  ), y = c(
    0,
