...
author: "Todd Hayden, Christopher Holbrook, Mike Lowe"
...
objects.  In `ggplot2` variables in data are mapped to aesthetic
...
large user-bases.  The `gganimate` package is an extension to
