...
##'   
##' @param input character, path 
##' to video file (any FFmpeg supported file type-
##'   *.mp4, *.wmv, etc)
...
##' 
##' @param ffmpeg NOTE: argument ignored. Not needed for package versions
##'   greater than 0.4.0.  Argument will be removed in a future version.
##'   
