...
test_that("detectionBubblePlot works for calculating the columns specified", {
  ...
  # Expected results
  dbpNumFishLocShouldBe <- c("OSC", "PRS", "TTB")
  dbpNumFishSummaryShouldBe <- rep(x=1, times=3)
  dbpNumFishMeanLatShouldBe <- c(42.67050, 42.27267, 42.88200)
  dbpNumFishMeanLonShouldBe <- c(-83.66775, -83.67000, -83.80467)
  dbpNumDetLocShouldBe <- c("PRS", "TTB", "OSC")
  dbpNumDetSummaryShouldBe <- c(3, 3, 4)
  dbpNumDetMeanLatShouldBe <- c(42.27267, 42.88200, 42.67050)
  dbpNumDetMeanLonShouldBe <- c(-83.67000, -83.80467, -83.66775)
