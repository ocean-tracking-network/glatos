...
# Test velTest function
test_that("velTestFunc works for calculating the columns specified and checking if the min_vel column is valid", {
  ...
  minVelShouldBe2 <-c(149.37496/436, 149.37496/243, 182.93891/169, 71.63089/60, 71.63089/60, 84.05377/115, 110.15029/121, 182.93891/191, 182.93891/191, 480.43047/530)
  ...
  expect_equal(velData$min_vel, minVelShouldBe2)
