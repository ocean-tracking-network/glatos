...
# Test numIntervalTest function
test_that("numDetectionsAndIntervalTest works for calculating the columns specified and checking if the min_vel column is valid", {
