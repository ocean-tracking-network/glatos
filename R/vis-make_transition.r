...
##'   shapefile.
##'
##' @param invert logical. Passes into gdal_rasterize. If true, it will return the inverse
##'   of the raster object it would normally return. This can be useful if the polygon passed
##'   represents a landmass rather than a body of water, such as the ones generated by GADM.
##'
