...
- ...:
  ...
  : must be character, identification code transmitted by the tag (e.g.,
    "1363" for Innovasea PPM coding").
  ...
  : must be POSIXct, timestamp (in UTC) when animal was released (i.e.,
    start of telemetry sampling interval.)
